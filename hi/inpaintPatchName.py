...
modelName = "weights/patch5_name.pd"
#$ tensorboard --logdir=/home/way/NVPACK/nvsample_workspace/python-mnist/hi/weights/logs_inpaint5
#browser  http://0.0.0.0:6006
logName ="weights/logs_inpaint5"
IMAGE_SIZE = 9
NUM_CHANNELS_In=5
NUM_CHANNELS_Out=4
PIXEL_DEPTH = 255
...
fc1_weights = tf.Variable(tf.truncated_normal(
      [IMAGE_SIZE // 1 * IMAGE_SIZE // 1 * conv2_weightCount, fc_weightCount],stddev=0.1,seed=SEED),name="fc1_w")
fc1_biases = tf.Variable(tf.constant(0.1, shape=[fc_weightCount]),name="fc1_b")
fc2_weights = tf.Variable(tf.truncated_normal([fc_weightCount, NUM_LABELS],stddev=0.1,seed=SEED),name="fc2_w")
fc2_biases = tf.Variable(tf.constant(0.1, shape=[NUM_LABELS]),name="fc2_b")
